...
{
   FsckTkEx::fsckOutput("* Duplicated content directores ...",
         OutputOptions_FLUSH | OutputOptions_LINEBREAK);
...
{
   FsckTkEx::fsckOutput("* Bad target mirror information in dentry ...",
         OutputOptions_FLUSH | OutputOptions_LINEBREAK);
...
{
   FsckTkEx::fsckOutput("* Bad content mirror information in dir inode ...",
         OutputOptions_FLUSH | OutputOptions_LINEBREAK);
...
{
   FsckTkEx::fsckOutput("* Bad content mirror information in file inode ...",
         OutputOptions_FLUSH | OutputOptions_LINEBREAK);

   ...
   struct CreateInfo* createInfo, EntryInfo* outEntryInfo)
{
   ...
   openRes = FhgfsOpsRemoting_openfile(outEntryInfo, &ioInfo, NULL);
   ...
   char __user *buf, size_t size, loff_t offset)
{
   ...
   openRes = FhgfsOpsRemoting_openfile(entryInfo, &ioInfo, NULL);
   ...
   size_t size, loff_t offset)
{
   ...
   referenceRes = FhgfsInode_referenceHandle(fhgfsInode, OPENFILE_ACCESS_WRITE, true, NULL,
      &handleType, NULL);

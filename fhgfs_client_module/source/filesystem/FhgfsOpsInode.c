...
#endif // KERNEL_HAS_ATOMIC_OPEN
{
   ...
   CreateInfo_init(app, dir, entryName, createMode, currentUmask, isExclusiveCreate, &createInfo);
   ...
   unsigned openFlags, umode_t createMode,  int* outOpenedFlags)
{
   ...
   if (isCreate)
   {
      ...
      CreateInfo_init(app, dir, entryName, createMode, createUmask, isExclusiveCreate, &createInfo);
      LookupIntentInfoIn_addCreateInfo(&inInfo, &createInfo);
   }

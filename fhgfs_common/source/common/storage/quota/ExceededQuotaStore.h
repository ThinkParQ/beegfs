...
class ExceededQuotaStore
{
   public:
      ...
      void getExceededQuota(UIntList* outIDList, QuotaDataType idType, QuotaLimitType exType);
   ...
   private:
      ...
      RWLock rwLockExceededLists;          // synchronize access to all exceeded ID sets
      ...
      void getExceededQuotaUnlocked(UIntList* outIDList, UIntSet* inIDList);

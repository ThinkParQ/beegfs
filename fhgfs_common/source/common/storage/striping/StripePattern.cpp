 ...
 */
StripePattern* StripePattern::deserialize(Deserializer& des)
{
   ...
   switch(header.type)
   {
      case StripePatternType_Raid0:
         pattern = new Raid0Pattern(header.chunkSize);
         break;

      case StripePatternType_Raid10:
         pattern = new Raid10Pattern(header.chunkSize);
         break;

      case StripePatternType_BuddyMirror:
         pattern = new BuddyMirrorPattern(header.chunkSize);
         break;

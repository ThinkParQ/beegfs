...
class TestRWLock: public CppUnit::TestFixture
{
   CPPUNIT_TEST_SUITE( TestRWLock );
   CPPUNIT_TEST( testReaderOnReader );
   CPPUNIT_TEST( testReaderOnWriter );
   CPPUNIT_TEST( testWriterOnReader );
   CPPUNIT_TEST( testWriterOnWriter );
   CPPUNIT_TEST( testRandomOnReader );
   CPPUNIT_TEST( testRandomOnWriter );
   CPPUNIT_TEST( testTryReadOnReader );
   CPPUNIT_TEST( testTryReadOnWriter );
   CPPUNIT_TEST( testTryWriteOnReader );
   CPPUNIT_TEST( testTryWriteOnWriter );
   CPPUNIT_TEST( testRandomTryOnReader );
   CPPUNIT_TEST( testRandomTryOnWriter );
   ...
   public:
      ...
      void testReaderOnReader();
      void testReaderOnWriter();
      void testWriterOnReader();
      void testWriterOnWriter();
      void testRandomOnReader();
      void testRandomOnWriter();

      void testTryReadOnReader();
      void testTryReadOnWriter();
      void testTryWriteOnReader();
      void testTryWriteOnWriter();
      void testRandomTryOnReader();
      void testRandomTryOnWriter();

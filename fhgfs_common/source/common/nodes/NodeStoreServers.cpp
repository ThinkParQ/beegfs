 ...
 * @return NULL if no such node exists
 */
NodeHandle NodeStoreServers::referenceRootNode(MirrorBuddyGroupMapper* metaBuddyGroupMapper) const
{
   std::lock_guard<Mutex> lock(mutex);
 ...
 */
NodeHandle NodeStoreServers::referenceNextNode(const NodeHandle& oldNode) const
{
   std::lock_guard<Mutex> lock(mutex);
 ...
 */
NodeHandle NodeStoreServers::referenceNodeByStringID(std::string nodeStrID) const
{
...
NumNodeID NodeStoreServers::getRootNodeNumID() const
{
   std::lock_guard<Mutex> lock(mutex);
   return rootNodeID;
}

bool NodeStoreServers::getRootIsBuddyMirrored() const
{
   std::lock_guard<Mutex> lock(mutex);
 ...
 */
NumNodeID NodeStoreServers::generateNodeNumID(Node& node) const
{
 ...
 * otherwise.
 */
bool NodeStoreServers::checkNodeNumIDCollision(NumNodeID numID) const
{

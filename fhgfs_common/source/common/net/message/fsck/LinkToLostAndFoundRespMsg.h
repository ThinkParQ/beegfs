...
class LinkToLostAndFoundRespMsg : public NetMessageSerdes<LinkToLostAndFoundRespMsg>
{
   ...
   public:
      ...
      {
         LinkToLostAndFoundRespMsg* other = (LinkToLostAndFoundRespMsg*) msg;
         return entryType == other->entryType
               && (entryType == FsckDirEntryType_DIRECTORY
                  ? *failedDirInodes == *other->failedDirInodes
                  : *failedFileInodes == *other->failedFileInodes)
               && *createdDentries == *other->createdDentries

...
class LinkToLostAndFoundMsg : public NetMessageSerdes<LinkToLostAndFoundMsg>
{
   ...
   public:
      ...
      {
         LinkToLostAndFoundMsg* other = (LinkToLostAndFoundMsg*) msg;
         return entryType == other->entryType
               && (entryType == FsckDirEntryType_DIRECTORY
                  ? *dirInodes == *other->dirInodes
                  : *fileInodes == *other->fileInodes)
               && *lostAndFoundInfoPtr == *other->lostAndFoundInfoPtr

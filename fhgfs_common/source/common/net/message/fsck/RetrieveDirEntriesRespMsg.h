...
class RetrieveDirEntriesRespMsg : public NetMessageSerdes<RetrieveDirEntriesRespMsg>
{
   ...
   public:
      ...
      virtual TestingEqualsRes testingEquals(NetMessage* msg)
      {
         ...
         if (! ListTk::listsEqual(this->fsckContDirs, &msgIn->getContDirs() ) )
            return TestingEqualsRes_FALSE;

         if (! ListTk::listsEqual(this->fsckDirEntries, &msgIn->getDirEntries() ) )
            return TestingEqualsRes_FALSE;

         if (! ListTk::listsEqual(this->inlinedFileInodes, &msgIn->getInlinedFileInodes() ) )
            return TestingEqualsRes_FALSE;

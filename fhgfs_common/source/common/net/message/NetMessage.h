...
{
   // u64 representation of "fhgfs04". since uint64_t is serialized as LE in the protocol, but
   // we want to have the string "fhgfs04" in the messages byte-for-byte, the bytes are
   // swapped here to compensate
   static const uint64_t MSG_PREFIX = 0x0034307366676866ULL;

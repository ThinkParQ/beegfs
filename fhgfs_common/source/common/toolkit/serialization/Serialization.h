...
class Serializer
{
   ...
   public:
      ...
      {
         putCollection(value.begin(), value.end(), ListSerializationHasLength<T>::value);
         return *this;
      }
      ...
      {
         putCollection(map.begin(), map.end(), MapSerializationHasLength<KeyT, ValueT>::value);
         return *this;
      }
   ...
   private:
      ...
      void putCollection(const Iter begin, const Iter end, const bool hasLengthField)
      {
         Serializer atStart = *this;
...
struct AsDes
{
   ...
   friend Serializer& operator%(Serializer& ser, AsDes value)
   {
      return ser % AsSer<Value, Raw>(*value.value);
   }
...
struct RawStringDes
{
   ...
   friend Serializer& operator%(Serializer& ser, const RawStringDes& str)
   {
      return ser % RawStringSer(*str.data, *str.size, str.align);
   }
...
struct AtomicAsDes
{
   ...
   friend Serializer& operator%(Serializer& ser, const AtomicAsDes& value)
   {
      return ser % as<As>(value.value->read() );
   }

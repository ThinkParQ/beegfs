...
void TestSerialization::testDynamicFileAttribs()
{
...
void TestSerialization::testChunkFileInfo()
{
   DynamicFileAttribs attribs(1, 2, 3, 4, 5);
...
void TestSerialization::testEntryLockDetails()
{
...
void TestSerialization::testRangeLockDetails()
{

...
REGISTER_TEST_SUITE(TestBuddyMirroring);
...
TestBuddyMirroring::TestBuddyMirroring() : log("TestSerialization")
{
}

TestBuddyMirroring::~TestBuddyMirroring()
{
}

void TestBuddyMirroring::setUp()
{
}

void TestBuddyMirroring::tearDown()
{
}

void TestBuddyMirroring::testSimpleEntryLocks()
{
   log.log(Log_DEBUG, "testSimpleEntryLocks started");
   ...
   log.log(Log_DEBUG, "testSimpleEntryLocks finished");
}

void TestBuddyMirroring::testRWEntryLocks()
{
   log.log(Log_DEBUG, "testRWEntryLocks started");
   ...
   log.log(Log_DEBUG, "testRWEntryLocks finished");
}

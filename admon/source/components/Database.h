...
class Database
{
   public:
      ...
      void cleanUp();
      bool metaNodeIsInGroup(NumNodeID nodeNumID, int group);
      bool metaNodeIsInGroup(NumNodeID nodeNumID, std::string group);
      bool storageNodeIsInGroup(NumNodeID nodeNumID, int group);
      bool storageNodeIsInGroup(NumNodeID nodeNumID, std::string group);

...
#define MODECREATEFILE_ARG_STORAGEPOOL    "--storagepool"
...
void ModeCreateFile::printHelp()
{
   ...
   std::cout << "   --storagepool=<poolID> The storage pool the new file should be in." << std::endl;
   ...
   std::cout << "    --numtargets=4 --storagepool=default /mnt/beegfs/myfile" << std::endl;
}

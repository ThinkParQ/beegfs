...
#define MODEGETQUOTAINFO_ARG_STORAGEPOOL        "--storagepool"
...
void ModeGetQuotaInfo::printHelp()
{
   ...
   std::cout << "    --storagepool=<ID> Only display used quota on targets, which belong to storage" << std::endl;
   ...
   std::cout << "  $ beegfs-ctl --getquota --uid 1000 --storagepool=2" << std::endl;
   std::cout << std::endl;
   std::cout << " Example: Show quota information for all normal users on storage pool 1." << std::endl;
   std::cout << "  $ beegfs-ctl --getquota --uid --all --storagepool=1" << std::endl;
   std::cout << std::endl;
   std::cout << " Example: Show quota information for user IDs 100 and 110 on storage pool 2." << std::endl;
   std::cout << "  $ beegfs-ctl --getquota --uid --list 100,110 --storagepool=2" << std::endl;
   std::cout << std::endl;

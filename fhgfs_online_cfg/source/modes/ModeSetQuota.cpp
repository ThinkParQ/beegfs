...
#define MODESETQUOTA_ARG_STORAGEPOOLID       "--storagepool"
...
int ModeSetQuota::checkConfig(StringMap* cfg)
{
   ...
   {
      std::cerr << "Choosing a storage pool with " << MODESETQUOTA_ARG_STORAGEPOOLID
...
void ModeSetQuota::printHelp()
{
   ...
   std::cout << std::endl;
   std::cout << "  Mandatory:" << std::endl;
   std::cout << "    --storagepool=<ID>    Modify quota limits for given storage pool." << std::endl;
   std::cout << std::endl;
   ...
   std::cout << "  # beegfs-ctl --setquota --sizelimit=50M --inodelimit=50 --storagepool=2 \\" << std::endl;
   ...
   std::cout << "  # beegfs-ctl --setquota --gid --file=/tmp/quota_limits.txt --storagepool=1" << std::endl;
   std::cout << std::endl;
   ...
   std::cout << "  # beegfs-ctl --setquota --uid --sizelimit=20M --inodelimit=500 --storagepool=1 \\" << std::endl;
   ...
   std::cout << "  # beegfs-ctl --setquota --sizelimit=unlimited --inodelimit=5000 --storagepool=2 --gid \\" << std::endl;
   ...
   std::cout << "  --storagepool=2" << std::endl;
   std::cout << std::endl;

#include "ReleaseAppendLockMsg.h"


bool ReleaseAppendLockMsg::deserializePayload(const char* buf, size_t bufLen)
{
   size_t bufPos = 0;
...
void ReleaseAppendLockMsg::serializePayload(char* buf)
{
   size_t bufPos = 0;

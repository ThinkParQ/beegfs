#include "TruncLocalFileRespMsg.h"


bool TruncLocalFileRespMsg::deserializePayload(const char* buf, size_t bufLen)
{
   size_t bufPos = 0;
...
void TruncLocalFileRespMsg::serializePayload(char* buf)
{
   size_t bufPos = 0;

#include "RetrieveDirEntriesMsg.h"

bool RetrieveDirEntriesMsg::deserializePayload(const char* buf, size_t bufLen)
{
   size_t bufPos = 0;
...
void RetrieveDirEntriesMsg::serializePayload(char* buf)
{
   size_t bufPos = 0;

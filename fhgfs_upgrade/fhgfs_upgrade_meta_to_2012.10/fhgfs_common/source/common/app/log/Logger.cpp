...
Logger::Logger(ICommonConfig* cfg) throw(InvalidConfigException)
{
   ...
   this->logErrsToStdlog = true; // always true for the upgrade tool

   // this->logNoDate = cfg->getLogNoDate();
   this->logNoDate = true; // always false for the upgrade tool
   ...
   this->logNumRotatedFiles = 0; // always zero for the upgrade tool

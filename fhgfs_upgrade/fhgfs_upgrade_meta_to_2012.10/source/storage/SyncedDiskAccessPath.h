...
//      // old version, that was not monotonic increasing (after a restart)
//      uint64_t incStorageVersion()
//      {
//         // avoids zero, because it is the invalid version
//         uint64_t currentVersion = ++storageVersion;
//         
//         return (currentVersion ? currentVersion : ++storageVersion);
//      }
